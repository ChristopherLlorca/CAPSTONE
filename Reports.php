...
$total_docs = $conn->query("SELECT COUNT(*) AS total FROM documents")->fetch_assoc()['total'];
...
$type_data = $conn->query("SELECT doc_type, COUNT(*) AS count FROM documents GROUP BY doc_type");
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">All Document Records</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php
                                $docs = $conn->query("SELECT * FROM documents ORDER BY date_created DESC");
                                if ($docs->num_rows > 0) {
