...
<head>
    ...
    <style>
        ...
        .search-card { margin-top: -60px; border: none; border-radius: 15px; }
        .status-badge { font-size: 0.9rem; padding: 8px 12px; }
        .instruction-step { display: flex; align-items: flex-start; margin-bottom: 15px; }
        .step-number { background: #0d6efd; color: white; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; margin-right: 12px; flex-shrink: 0; }
    </style>
</head>
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 mb-4">
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        <h5 class="card-title fw-bold mb-4"><i class="bi bi-info-circle text-primary me-2"></i>Instructions</h5>
                        
                        <div class="instruction-step">
                            <div class="step-number">1</div>
                            <p class="mb-0 text-muted">Locate your <strong>Tracking Number</strong> or use your <strong>Student ID</strong>.</p>
                        </div>
                        <div class="instruction-step">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="">
                            <div class="row g-2 align-items-end">
                                <div class="col-md-9">
                                    <label for="searchQuery" class="form-label fw-semibold">Tracking Number or Student ID</label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white"><i class="bi bi-search"></i></span>
                                        <input type="text" id="searchQuery" name="searchQuery" class="form-control form-control-lg" placeholder="Enter ID or Tracking No." value="<?php echo isset($_POST['searchQuery']) ? htmlspecialchars($_POST['searchQuery']) : ''; ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <div class="card shadow-sm border-0 overflow-hidden mb-4">
                                <div class="card-header bg-success text-white py-2">
                                    <small class="fw-bold text-uppercase">Tracking No: <?php echo htmlspecialchars($doc['tracking_number']); ?></small>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-muted">ID: <?php echo htmlspecialchars($doc['student_id']); ?></small>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge status-badge" style="background-color: 
                                                        ...
                                                        switch($doc['status']) {
                                                            ...
                                                            case 'Approved': echo '#0d6efd'; break;
                                                            default: echo '#6c757d';
                                                        }
                                                        ?>;">
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="bi bi-geo-alt-fill text-danger me-1"></i><?php echo htmlspecialchars($doc['current_location']); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="ps-4 fw-bold text-muted">Date Requested</td>
                                                <td>
                                                    <i class="bi bi-calendar3 me-1"></i> <?php echo date('F j, Y', strtotime($doc['date_created'])); ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
