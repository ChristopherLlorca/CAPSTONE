...
<main>
    <div class="main-container">
        <div class="background-slideshow"></div> <!-- New div for slideshow background -->
        <div id="left-panel">
            <div class="p-4">
...
<script>
    // Array of background images (add your image filenames here)
    const images = ['bg1.webp', 'bg2.webp', 'bg3.webp']; // Replace with your actual images
    let currentIndex = 0;
    const slideshowDiv = document.querySelector('.background-slideshow');
    const interval = 5000; // Change image every 5 seconds (adjust as needed)
